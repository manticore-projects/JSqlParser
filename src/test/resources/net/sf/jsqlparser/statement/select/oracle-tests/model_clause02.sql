...
--@FAILURE: select country,year,sale,csum from(select country,year,sum(sale)sale from sales_view_ref group by country,year)model recorded first on 10 Jun 2022, 15:49:34