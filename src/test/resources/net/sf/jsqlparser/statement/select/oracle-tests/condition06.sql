...
--@FAILURE: select*from t1,t2 where(trunc(t1.timestamp)between to_date('110226','yymmdd')and to_date('110326','yymmdd'))and t1.code(+)='cn' and t1.id(+)=t2.id and t1.cid=t2.cid and t1.mid=1245714070376993504 and t1.tmst>=to_date('110226','yymmdd')and shipper.alt_party_code recorded first on 10 Jun 2022, 15:49:34