...
--@FAILURE: select time_id,product,last_value(quantity ignore nulls)over(partition by product order by time_id)quantity,last_value recorded first on 10 Jun 2022, 15:49:34